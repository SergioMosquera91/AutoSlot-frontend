  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await vehiculoService.crear({
        ...
        slot: form.slot ? Number(form.slot) : null,
      ...
      <div className="pagina__encabezado">
        <div>
          ...
          <p className="pagina__sub">
            Registro de vehículos del sistema AutoSlot
          </p>
        </div>
        <button
              ...
              <tbody>
                {listaFiltrada.map((v, i) => (
                  <tr key={v.idVehiculo}>
                    ...
                    <td>
                      <span
                        className={`badge ${colorTipo[v.tipo] || "badge--azul"}`}
                      >
            ...
            <form className="modal__cuerpo" onSubmit={handleSubmit} noValidate>
              <div className="form-fila">
                <div className="form-grupo">
                  ...
                  />
                  {errores.placa && (
                    <span className="form-error">{errores.placa}</span>
                  )}
                </div>
                <div className="form-grupo">
                  <label className="form-label">Slot *</label>
                  <input
                    className={`form-input ${errores.slot ? "error" : ""}`}
                    type="number"
                    min="1"
                    max="999"
                    value={form.slot}
                  ...
                  />
                  {errores.slot && (
                    <span className="form-error">{errores.slot}</span>
                  )}
              ...
              <div className="form-fila">
                <div className="form-grupo">
                  ...
                  />
                  {errores.marca && (
                    <span className="form-error">{errores.marca}</span>
                  )}
                </div>
                <div className="form-grupo">
